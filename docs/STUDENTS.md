...
```
ghcr.io/illinois-containers/cs341:sp27-img1
```
...
```
docker pull ghcr.io/illinois-containers/cs341:sp27-img1
```
...
docker run --rm -it \
  ...
  -w /home/student/work \
  ghcr.io/illinois-containers/cs341:sp27-img1 bash
```
...
There is no `latest` tag, on purpose. The plain tag `cs341:sp27-img1` **moves** when staff publish an update.
...
```
docker inspect --format='{{index .RepoDigests 0}}' ghcr.io/illinois-containers/cs341:sp27-img1
```

which prints something like

```
ghcr.io/illinois-containers/cs341:sp27-img1@sha256:3f8c...
```
...
docker run --rm -it \
  -v ~/cs341:/home/student/work -w /home/student/work \
  ghcr.io/illinois-containers/cs341:sp27-img1@sha256:3f8c... bash
```
...
```
ghcr.io/illinois-containers/cs341:sp27-img1:cs341:sp27-img1-20260919-a1b2c3d
```
